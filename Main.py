...
class Trucks:
    def __init__(self, speed, miles, packages, current_location, departure_time):
        self.speed = speed
        self.miles = miles
    ...
    def __str__(self):
        return "%s, %s, %s, %s, %s, %s" % (
            self.speed, self.miles, self.packages, self.current_location, self.departure_time, self.time)
...
def package_delivery(truck):
    ...
    # clearing package list to load packages in trucks using nearest neighbor algorith
